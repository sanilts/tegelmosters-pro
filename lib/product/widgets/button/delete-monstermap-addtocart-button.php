<?php
class Custom_Add_To_Cart_Widget extends \Elementor\Widget_Base {
    public function get_name() {
        return 'custom_add_to_cart';
    }

    public function get_title() {
        return 'TM Custom Add to Cart Button';
    }
    ...
    protected function render() {
        ...
        $monstermap_id = get_post_meta($collection_id, 'montermap_product_id', true);
